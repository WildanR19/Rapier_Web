            ...
            @foreach ($projects as $project)    
                <li class="card w-100 p-4 mb-4">
                    <div class="row no-gutters justify-content-between mb-3">
                        ...
                        @endphp
                        <h6 class="text-{{$text}}"><em>{{ ucwords($project->status) }}</em></h6>
                        <div>
                            @php
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-12">
                            <p>{{ $project->progress_percent }}% Complete</p>
                        </div>
                    </div>
                        ...
                        <div>
                            <ul class="row no-gutters list-assigned p-0">
                                ...
                                @if ($members->where('project_id', $project->id)->count() > 5)
                                    <li class="ml-2"><a href="" onclick="return false" class="align-middle">and {{ ($members->where('project_id', $project->id)->count() - 5) }} more</a></li>
                                @endif
                            </ul>
                        </div>
